...
std::pair<int, int> gnuplot::gnuplot_version() {
    ...
    if (dont_know_gnuplot_version) {
        ...
        std::string version_major =
            std::regex_replace(version_str, std::regex("[^]*gnuplot (\\d+)\\.\\d+ patchlevel \\d+ *"), "$1");
...
bool gnuplot::terminal_has_size_option(const std::string &t) {
    ...
    constexpr std::string_view whitelist[] = {"qt",  "aqua", "caca",    "canvas",   "eepic",   "emf", "gif", "jpeg",
...
bool gnuplot::terminal_has_enhanced_option(const std::string &t) {
    constexpr std::string_view whitelist[] = {"canvas",  "postscript", "qt",       "aqua",       "caca",    "canvas",
...
bool gnuplot::terminal_has_color_option(const std::string &t) {
    constexpr std::string_view whitelist[] = {"postscript", "aifm",    "caca",     "cairolatex", "context",  "corel",
...
bool gnuplot::terminal_has_font_option(const std::string &t) {
    ...
    constexpr std::string_view blacklist[] = {
        "dxf",      "eepic",   "emtex",   "hpgl",    "latex",    "mf",       "pcl5",   "pslatex", "pstex",   "pstricks",
        "qms",      "tek40xx", "tek410x", "texdraw", "tkcanvas", "vttek",    "xterm",  "jpeg",    "dumb",    "tpic",
        "sixelgd",  "png",     "lua",     "jpeg",    "epscairo", "epslatex", "canvas", "dumb",    "dxy800a", "emxvga",
        "pdfcairo", "cgi",     "gif",     "gpic",    "grass",    "hp2623a",  "hp2648", "hp500c",  "hpgl",    "pcl5",
        "hpljii",   "hppj",    "imagen",  "linux",   "lua",      "lua tikz", "mf",     "mif",     "mp",      "pbm",
        "pm",       "qms",     "regis",   "svga",    "texdraw",  "tikz",     "tpic",   "vgagl",   "vws",     "pdf"};
