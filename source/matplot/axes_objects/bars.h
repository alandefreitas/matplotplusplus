...
namespace matplot {
    ...
    public:
        ...
        bars(class axes* parent, const std::vector<double>& x, const std::vector<double>& y);
        bars(class axes* parent, const std::vector<double>& x, const std::vector<std::vector<double>>& Y);
