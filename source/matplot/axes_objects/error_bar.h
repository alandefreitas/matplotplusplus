...
class error_bar : public line {
   ...
   public:
    ...
    error_bar(class axes* parent, const std::vector<double>& x, const std::vector<double>& y,
    ...
    error_bar(class axes* parent, const std::vector<double>& x_data, const std::vector<double>& y_data,
