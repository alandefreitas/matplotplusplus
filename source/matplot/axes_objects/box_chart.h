...
class box_chart : public axes_object {
   ...
   public:
    ...
    //        box_chart(class xlim* parent, const std::vector<double>& data, const
    //        std::vector<double>& edges, enum box_chart::normalization
    //        normalization_alg = box_chart::normalization::count);
    ...
    template <class... Args>
    box_chart(const axes_handle& parent, Args... args) : box_chart(parent.get(), args...) {}
