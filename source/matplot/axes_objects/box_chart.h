...
namespace matplot {
    ...
    public:
        ...
        box_chart(class axes* parent, const std::vector<double>& y_data, const std::vector<double>& groups = {});
//        box_chart(class xlim* parent, const std::vector<double>& data, const std::vector<double>& edges, enum box_chart::normalization normalization_alg = box_chart::normalization::count);
//        box_chart(class xlim* parent, const std::vector<double>& data, binning_algorithm algorithm = binning_algorithm::automatic, box_chart::normalization normalization_alg = box_chart::normalization::count);
    ...
    public /* getters and setters */:
        ...
        class box_chart& whisker_style(enum line_spec::marker_style whisker_style);
    ...
    protected:
        ...
        enum line_spec::marker_style whisker_style_{line_spec::marker_style::circle};
