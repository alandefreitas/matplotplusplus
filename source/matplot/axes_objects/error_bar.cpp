...
error_bar::error_bar(class axes* parent, const std::vector<double>& x, const std::vector<double>& y,
...
std::string error_bar::data_string() {
    ...
    if (has_xy_bar) {
        for (size_t i = 0; i < y_data_.size(); ++i) {
            ss << "    " << x_data_[i] << " " << y_data_[i] << " " << x_data_[i] - x_negative_delta_[i] << " "
               << x_data_[i] + x_positive_delta_[i] << " " << y_data_[i] - y_negative_delta_[i] << " "
        ...
        if (!filled_curve_) {
            for (size_t i = 0; i < y_data_.size(); ++i) {
                ss << "    " << x_data_[i] << " " << y_data_[i] << " " << y_data_[i] - y_negative_delta_[i] << " "
                   << y_data_[i] + y_positive_delta_[i] << "\n";
            }
            ss << "    e\n";
        } else {
            for (size_t i = 0; i < y_data_.size(); ++i) {
                ss << "    " << x_data_[i] << " " << y_data_[i] + y_positive_delta_[i] << " "
...
const std::vector<double>& error_bar::x_negative_delta() const { return x_negative_delta_; }
...
const std::vector<double>& error_bar::x_positive_delta() const { return x_positive_delta_; }
...
const std::vector<double>& error_bar::y_negative_delta() const { return y_negative_delta_; }
...
const std::vector<double>& error_bar::y_positive_delta() const { return y_positive_delta_; }
