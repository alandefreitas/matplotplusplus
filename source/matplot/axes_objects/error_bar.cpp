...
error_bar::error_bar(class axes* parent, const std::vector<double>& x,
    ...
    : line(parent, x, y, line_spec),
      ...
      y_positive_delta_(type != error_bar::type::horizontal
                            ...
                            : std::vector<double>({})),
      x_negative_delta_(
          type != error_bar::type::vertical ? error : std::vector<double>({})),
      x_positive_delta_(
          type != error_bar::type::vertical ? error : std::vector<double>({})) {
}
...
class error_bar& error_bar::x_negative_delta(
    const std::vector<double>& x_negative_delta) {
...
class error_bar& error_bar::x_positive_delta(
    const std::vector<double>& x_positive_delta) {
...
class error_bar& error_bar::y_negative_delta(
    const std::vector<double>& y_negative_delta) {
...
class error_bar& error_bar::y_positive_delta(
    const std::vector<double>& y_positive_delta) {
