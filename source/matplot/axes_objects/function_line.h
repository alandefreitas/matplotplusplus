...
namespace matplot {
    ...
    public:
        ...
        function_line(class axes* parent, const function_type& equation, std::array<double,2> x_range = {-5,5}, const std::string& line_spec = "");

        function_line(class axes* parent, const function_type& function_x, const function_type& function_y, std::array<double,2> t_range = {-5,5}, const std::string& line_spec = "");

        function_line(class axes* parent, const function_type& function_x, const function_type& function_y, const function_type& function_z, std::array<double,2> t_range = {-5,5}, const std::string& line_spec = "");

        /// If we receive an axes_handle, we can convert it to a raw
        /// pointer because there is no ownership involved here
        template <class ...Args>
        function_line(const axes_handle& parent, Args... args) : function_line(parent.get(), args...) {}
    ...
    public:
        ...
        class function_line& automatic_mesh_density(bool automatic_mesh_density);
