...
class histogram : public axes_object {
 ...
 public /* useful functions for histograms */:
  ...
  static std::vector<double> bin_picker(double xmin, double xmax, size_t nbins,
                                        double bin_width);
  ...
  static std::vector<size_t> histogram_count(const std::vector<double>& values,
                                             const std::vector<double>& edges);

  /// Normalize the instagram count
  static std::vector<double> histogram_normalize(
      const std::vector<size_t>& bin_count,
 ...
 public /* getters and setters */:
  ...
  static std::vector<double> scotts_rule(const std::vector<double>& x,
                                         ...
                                         bool hard_limits);
  static std::vector<double> fd_rule(const std::vector<double>& x, double minx,
