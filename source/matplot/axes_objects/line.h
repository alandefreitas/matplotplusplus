...
class line : public axes_object {
   public:
    ...
    line(class axes* parent, const std::vector<double>& x_data, const std::vector<double>& y_data,
    ...
    template <class... Args>
    line(const axes_handle& parent, Args... args) : line(parent.get(), args...) {}
   ...
   public /* getters and setters bypassing the line_spec */:
    ...
    template <class T>
    class line& marker_style(T marker_style) {
    ...
    template <class T>
    class line& marker_face_color(T c) {
