...
namespace matplot {
    ...
    network::network(class axes* parent, const std::vector<std::pair<size_t,size_t>>& edges, const vector_1d& weights, size_t n_vertices, const std::string& line_spec)
    ...
    const line_spec &network::line_spec() const {
        return line_spec_;
    }

    line_spec &network::line_spec() {
        return line_spec_;
    }
    ...
    const std::vector<double> &network::y_data() const {
        return y_data_;
    }
    ...
    const std::vector<double> &network::x_data() const {
        return x_data_;
    }
    ...
    const std::vector<double> &network::z_data() const {
        return z_data_;
    }
    ...
    float network::line_width() const {
    ...
    float network::marker_size() const {
    ...
    bool network::marker_face() const {
    ...
    bool network::show_labels() const {
        return show_labels_;
    }
    ...
    const vector_1d &network::weights() const {
        return weights_;
    }
    ...
    int network::layout_iterations() const {
        return layout_iterations_;
    }
    ...
    double network::energy_threshold() const {
