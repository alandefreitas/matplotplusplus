...
class vectors : public axes_object {
   public:
    ...
    vectors(class axes* parent, const std::vector<double>& u_data, const std::vector<double>& v_data,
    ...
    vectors(class axes* parent, const std::vector<double>& x_data, const std::vector<double>& y_data,
            const std::vector<double>& u_data, const std::vector<double>& v_data, const std::string& line_spec = "");

    vectors(class axes* parent, const std::vector<double>& x_data, const std::vector<double>& y_data,
            const std::vector<double>& z_data, const std::vector<double>& u_data, const std::vector<double>& v_data,
            const std::vector<double>& w_data, const std::string& line_spec = "");

    /// If we receive an axes_handle, we can convert it to a raw
    /// pointer because there is no ownership involved here
    template <class... Args>
    vectors(const axes_handle& parent, Args... args) : vectors(parent.get(), args...) {}
