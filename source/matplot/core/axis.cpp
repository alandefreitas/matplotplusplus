...
bool axis::limits_mode_auto() const { return limits_mode_auto_ || (!isfinite(limits_[0]) && !isfinite(limits_[0])); }
...
const std::string& axis::tick_label_format() const { return tick_label_format_; }
