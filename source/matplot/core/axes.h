...
class axes : public std::enable_shared_from_this<class axes> {
 public:
  ...
  // {x, y, width, height}
  static constexpr std::array<float, 4> default_axes_position{.13, .11, .775,
                                                              .815};
 ...
 public /* create plots on the axes */:
  ...
  line_handle plot(const std::vector<double> &x, const std::vector<double> &y,
  ...
  std::vector<line_handle> rgbplot(
      const std::vector<std::vector<double>> &colormap);

  /// Plot 3d line plot
  line_handle plot3(const std::vector<double> &x, const std::vector<double> &y,
                    const std::vector<double> &z,
                    const std::string &line_spec = "");

  /// Plot 3d line plot - lists of Xs and Ys
  std::vector<line_handle> plot3(const std::vector<std::vector<double>> &X,
                                 const std::vector<std::vector<double>> &Y,
                                 const std::vector<double> &z,
                                 const std::string &line_spec = "");
  ...
  std::vector<stair_handle> stairs(const std::vector<double> &x,
                                   const std::vector<std::vector<double>> &Y,
                                   const std::string &line_spec = "");
  ...
  std::vector<stair_handle> stairs(const std::vector<std::vector<double>> &Y,
                                   const std::string &line_spec = "");
  ...
  std::vector<filled_area_handle> area(
  ...
  filled_area_handle area(const std::vector<double> &x,
                          const std::vector<double> &y, double base_value = 0.,
                          bool stacked = true,
                          const std::string &line_spec = "k-");
  ...
  filled_area_handle area(const std::vector<double> &y, double base_value = 0.,
                          bool stacked = true,
                          const std::string &line_spec = "k-");
  ...
  std::vector<string_function_handle> fplot(
  ...
  function_line_handle fplot(function_line::function_type function_x,
                             ...
                             const std::array<double, 2> &t_range = {-5, 5},
                             const std::string &line_spec = "");

  /// Lambda function line plot - list of functions
  std::vector<function_line_handle> fplot(
  ...
  line_handle fimplicit(implicit_function_type equation,
                        const std::array<double, 4> &xy_interval = {-5, 5, -5,
                                                                    5},
                        const std::string &line_spec = "");
  ...
  std::vector<bars_handle> barstacked(
      const std::vector<std::vector<double>> &Y);
  ...
  parallel_lines_handle parallelplot(const std::vector<std::vector<double>> &X,
  ...
  /// Wordcloud from text
  labels_handle wordcloud(const std::string &text,
  ...
  std::pair<bars_handle, line_handle> pareto(
      const std::vector<double> &y, const std::vector<std::string> &names = {},
      double p_threshold = 0.95, size_t item_threshold = 10);

  /// Core plot function
  line_handle stem(const std::vector<double> &x, const std::vector<double> &y,
                   const std::string &line_spec = "-o");
  ...
  line_handle stem3(const std::vector<double> &x, const std::vector<double> &y,
                    const std::vector<double> &z,
                    const std::string &line_spec = "-o");

  /// 3d-stem lists of Xs and Ys
  std::vector<line_handle> stem3(const std::vector<std::vector<double>> &X,
                                 const std::vector<std::vector<double>> &Y,
                                 const std::vector<double> &z,
                                 const std::string &line_spec = "-o");
  ...
  /// Adjust limits and reload that region of the world map in the proper
  /// resolution
  void geolimits(double latitude_min, double latitude_max, double longitude_min,
  ...
  std::vector<string_function_handle> ezpolar(
  ...
  std::vector<function_line_handle> ezpolar(
      std::vector<function_line::function_type> equations,
  ...
  line_handle polarscatter(
      const std::vector<double> &theta, const std::vector<double> &rho,
  ...
  vectors_handle quiver3(const std::vector<double> &x,
                         ...
                         const std::vector<double> &u,
                         const std::vector<double> &v,
                         const std::vector<double> &w, double scale = 1.0,
                         const std::string &line_spec = "");
  ...
  surface_handle fmesh(fcontour_function_type funx, fcontour_function_type funy,
  ...
  surface_handle fsurf(fcontour_function_type funx, fcontour_function_type funy,
                       fcontour_function_type funz,
                       const std::array<double, 2> &u_range,
                       const std::array<double, 2> &v_range,
                       std::string line_spec = "", double mesh_density = 40);
  ...
  matrix_handle image(const std::tuple<std::vector<std::vector<double>>,
  ...
  std::pair<labels_handle, vectors_handle> textarrow(double x1, double y1,
                                                     double x2, double y2,
                                                     const std::string &str);
  ...
  std::pair<labels_handle, line_handle> textbox(double x, double y, double w,
                                                double h,
                                                const std::string &str);

  /// Annotate plot with a filled polygon
  line_handle fill(const std::vector<double> &x, const std::vector<double> &y,
                   const std::string &line_spec = "");
 ...
 public /* create plots on the axes from ranges we can convert to
  ...
  line_handle plot(const IterableValues<T1> &x, const IterableValues<T2> &y,
                   const std::string &line_spec = "") {
  ...
  line_handle plot3(const IterableValues<T1> &x, const IterableValues<T2> &y,
  ...
  template <class T1, class T2, class T3>
  std::enable_if_t<is_iterable_value_v<T3>, std::vector<line_handle>> plot3(
      const IterableIterables<T1> &X, const IterableIterables<T2> &Y,
      const IterableValues<T3> &z, const std::string &line_spec = "") {
    return plot3(to_vector_2d(X), to_vector_2d(Y), to_vector_1d(z), line_spec);
  }

  template <class T1, class T2, class T3>
  std::enable_if_t<is_iterable_iterable_v<T3>, std::vector<line_handle>> plot3(
      const IterableIterables<T1> &X, const IterableIterables<T2> &Y,
  ...
  template <class T1, class T2>
  stair_handle stairs(const IterableValues<T1> &x, const IterableValues<T2> &y,
                      const std::string &line_spec = "") {
  ...
  template <class T1, class T2>
  std::enable_if_t<is_iterable_value_v<T1>, std::vector<stair_handle>> stairs(
      const IterableValues<T1> &x, const IterableIterables<T2> &Y,
      const std::string &line_spec = "") {
  ...
  error_bar_handle errorbar(const IterableValues<T1> &x,
                            ...
                            error_bar::type type = error_bar::type::vertical,
                            const std::string &line_spec = "") {
    return errorbar(to_vector_1d(x), to_vector_1d(y), to_vector_1d(error), type,
                    line_spec);
  }
  ...
  error_bar_handle errorbar(const IterableValues<T1> &x,
                            ...
                            const std::string &line_spec = "") {
    return errorbar(to_vector_1d(x), to_vector_1d(y), to_vector_1d(y_neg_delta),
  ...
  error_bar_handle errorbar(const IterableValues<T1> &x,
                            ...
                            const std::string &line_spec) {
    return errorbar(to_vector_1d(x), to_vector_1d(y), to_vector_1d(y_error),
                    line_spec);
  }

  template <class T1, class T2>
  std::vector<filled_area_handle> area(const IterableValues<T1> &x,
                                       const IterableIterables<T2> &Y,
                                       double base_value = 0.,
                                       bool stacked = true,
                                       const std::string &line_spec = "k-") {
  ...
  filled_area_handle area(const IterableValues<T1> &x,
                          const IterableValues<T2> &y, double base_value = 0.,
                          bool stacked = true,
                          const std::string &line_spec = "k-") {
  ...
  template <class T1>
  std::vector<filled_area_handle> area(const IterableIterables<T1> &Y,
                                       double base_value = 0.,
                                       bool stacked = true,
                                       const std::string &line_spec = "k-") {
  ...
  template <class T1>
  filled_area_handle area(const IterableValues<T1> &y, double base_value = 0.,
                          bool stacked = true,
                          const std::string &line_spec = "k-") {
  ...
  axes_object_handle binscatter(
      ...
      enum histogram::normalization normalization_alg =
          histogram::normalization::count) {
    return binscatter(to_vector_1d(x), to_vector_1d(y), to_vector_1d(edges_x),
                      to_vector_1d(edges_y), scatter_style, normalization_alg);
  }
  ...
  template <class T1, class T2>
  axes_object_handle binscatter(
      const IterableValues<T1> &x, const IterableValues<T2> &y, size_t nbins_x,
      size_t nbins_y,
      enum bin_scatter_style scatter_style = bin_scatter_style::automatic,
      enum histogram::normalization normalization_alg =
          histogram::normalization::count) {
    return binscatter(to_vector_1d(x), to_vector_1d(y), nbins_x, nbins_y,
                      scatter_style, normalization_alg);
  }

  template <class T1>
  std::enable_if_t<is_iterable_value_v<T1>, box_chart_handle> boxplot(
      const IterableValues<T1> &data) {
    return boxplot(to_vector_1d(data));
  }

  template <class T1>
  std::enable_if_t<is_iterable_iterable_v<T1>, box_chart_handle> boxplot(
      const IterableIterables<T1> &data) {
  ...
  template <class T1, class T2>
  std::enable_if_t<is_iterable_value_v<T2>, bars_handle> bar(
      const IterableValues<T1> &x, const IterableValues<T2> &y) {
    return bar(to_vector_1d(x), to_vector_1d(y));
  }

  template <class T1>
  std::enable_if_t<is_iterable_value_v<T1>, bars_handle> bar(
      const IterableValues<T1> &y) {
    return bar(to_vector_1d(y));
  }

  template <class T1>
  std::enable_if_t<is_iterable_iterable_v<T1>, bars_handle> bar(
      const IterableIterables<T1> &Y) {
    return bar(to_vector_2d(Y));
  }

  template <class T1, class T2>
  std::enable_if_t<is_iterable_iterable_v<T2>, bars_handle> bar(
      const IterableValues<T1> &x, const IterableIterables<T2> &Y) {
  ...
  template <class T1, class T2, class T3, class T4>
  line_handle scatter(const IterableValues<T1> &x, const IterableValues<T2> &y,
                      const IterableValues<T3> &sizes = {},
                      const IterableValues<T4> &colors = {}) {
    return scatter(to_vector_1d(x), to_vector_1d(y), to_vector_1d(sizes),
                   to_vector_1d(colors));
  }

  template <class T1, class T2, class T3>
  line_handle scatter(const IterableValues<T1> &x, const IterableValues<T2> &y,
                      double sizes, const IterableValues<T3> &colors = {}) {
    return scatter(to_vector_1d(x), to_vector_1d(y), sizes,
                   to_vector_1d(colors));
  }

  template <class T1, class T2, class T3, class T4, class T5>
  line_handle scatter3(const IterableValues<T1> &x, const IterableValues<T2> &y,
                       const IterableValues<T3> &z,
                       const IterableValues<T4> &sizes = {},
                       const IterableValues<T5> &colors = {},
                       const std::string &line_spec = "o") {
    return scatter3(to_vector_1d(x), to_vector_1d(y), to_vector_1d(z),
                    to_vector_1d(sizes), to_vector_1d(colors), line_spec);
  }
  ...
  template <class T1>
  std::pair<bars_handle, line_handle> pareto(
      const IterableValues<T1> &y, const std::vector<std::string> &names = {},
      double p_threshold = 0.95, size_t item_threshold = 10) {
    return pareto(to_vector_1d(y), names, p_threshold, item_threshold);
  }

  template <class T1, class T2>
  line_handle stem(const IterableValues<T1> &x, const IterableValues<T2> &y,
                   const std::string &line_spec = "-o") {
  ...
  template <class T1, class T2, class T3>
  line_handle stem3(const IterableValues<T1> &x, const IterableValues<T2> &y,
                    const IterableValues<T3> &z,
                    const std::string &line_spec = "-o") {
  ...
  line_handle geodensityplot(const IterableValues<T1> &latitude,
    ...
    return geodensityplot(to_vector_1d(latitude), to_vector_1d(longitude),
  ...
  template <class T1, class T2, class T3, class T4>
  line_handle polarscatter(
      const IterableValues<T1> &theta, const IterableValues<T2> &rho,
  ...
  contours_handle contour(const IterableIterables<T1> &X,
                          ...
                          const std::string &line_spec = "") {
    return contour(to_vector_2d(X), to_vector_2d(Y), to_vector_2d(Z), n_levels,
                   line_spec);
  }
  ...
  contours_handle contourf(const IterableIterables<T1> &X,
                           ...
                           const IterableIterables<T3> &Z, size_t n_levels = 0,
                           const std::string &line_spec = "") {
    return contourf(to_vector_2d(X), to_vector_2d(Y), to_vector_2d(Z), n_levels,
                    line_spec);
  }
  ...
  template <class T1, class T2, class T3, class T4>
  std::enable_if_t<is_iterable_iterable_v<T1> && is_iterable_iterable_v<T2> &&
  ...
  quiver3(const IterableValues<T1> &x, const IterableValues<T2> &y,
    ...
    return quiver3(to_vector_1d(x), to_vector_1d(y), to_vector_1d(z),
                   to_vector_1d(u), to_vector_1d(v), to_vector_1d(w), scale,
                   line_spec);
  }
  ...
  quiver3(const IterableIterables<T1> &x, const IterableIterables<T2> &y,
    ...
    return quiver3(to_vector_2d(x), to_vector_2d(y), to_vector_2d(z),
                   to_vector_2d(u), to_vector_2d(v), to_vector_2d(w), scale,
                   line_spec);
  }
  ...
  vectors_handle quiver3(const IterableIterables<T1> &z,
                         ...
                         const IterableIterables<T4> &w, double scale = 1.0,
                         const std::string &line_spec = "") {
  ...
  surface_handle surf(const IterableIterables<T1> &X,
                      ...
                      const IterableIterables<T4> &C = {},
                      std::string line_spec = "") {
    return IterableIterables(to_vector_2d(X), to_vector_2d(Y), to_vector_2d(Z),
                             to_vector_2d(C), line_spec);
  }
  ...
  template <class T1, class T2, class T3>
  matrix_handle image(
      const std::tuple<IterableIterables<T1>, IterableIterables<T2>,
  ...
  template <class T1, class T2>
  line_handle fill(const IterableValues<T1> &x, const IterableValues<T2> &y,
                   const std::string &line_spec = "") {
 ...
 private /* members */:
  ...
  std::vector<std::array<float, 4>> colororder_{
      ...
      default_color(4), default_color(5), default_color(6)};
