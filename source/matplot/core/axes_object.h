...
class axes_object {
   public:
    enum class axes_category { two_dimensional, three_dimensional, three_dimensional_map, polar };
   ...
   public:
    ...
    virtual std::string legend_string(std::vector<std::string>::iterator& legends_begin,
