...
legend::legend(class axes *parent, std::initializer_list<std::string> names) : legend(parent, std::vector(names)) {}

legend::legend(class axes *parent, const std::vector<std::string> &names) : parent_(parent), strings_(names) {
...
const std::string &legend::operator[](size_t index) const { return strings_.operator[](index); }

std::string &legend::operator[](size_t index) { return strings_.operator[](index); }

size_t legend::size() const { return strings_.size(); }

bool legend::empty() const { return strings_.empty(); }

std::vector<std::string>::const_iterator legend::begin() const { return strings_.begin(); }

std::vector<std::string>::iterator legend::begin() { return strings_.begin(); }

std::vector<std::string>::const_iterator legend::end() const { return strings_.end(); }
...
legend::horizontal_alignment legend::horizontal_location() const { return horizontal_location_; }

void legend::horizontal_location(legend::horizontal_alignment horizontal_location) {
    horizontal_location_ = horizontal_location;
}

legend::vertical_alignment legend::vertical_location() const { return vertical_location_; }

void legend::vertical_location(legend::vertical_alignment vertical_location) { vertical_location_ = vertical_location; }
