...
namespace matplot {
    ...
    std::vector<std::string>::iterator legend::end() {
        return strings_.end();
    }

    const std::vector<std::string> &legend::strings() const {
        return strings_;
    }

    std::vector<std::string> &legend::strings() {
        return strings_;
    }
    ...
    bool legend::inside() const {
        return inside_;
    }

    bool legend::label_after_sample() const {
        return label_after_sample_;
    }
    ...
    const line_spec &legend::box_line() const {
        return box_line_;
    }

    line_spec &legend::box_line() {
        return box_line_;
    }
    ...
    bool legend::horizontal() const {
        return !vertical();
    }

    void legend::horizontal(bool horizontal) {
        vertical(!horizontal);
    }
    ...
    void legend::horizontal_location(legend::horizontal_alignment horizontal_location) {
    ...
    void legend::vertical_location(legend::vertical_alignment vertical_location) {
        vertical_location_ = vertical_location;
    }

    bool legend::manual_position() const {
    ...
    const std::array<float, 2> &legend::position() const {
        return position_;
    }
    ...
    const std::string &legend::title() const {
        return title_;
    }
    ...
    const std::string &legend::font_name() const {
        return font_name_;
    }
    ...
    const std::string &legend::font_angle() const {
        return font_angle_;
    }
    ...
    const std::string &legend::font_weight() const {
        return font_weight_;
    }
    ...
    const color_array &legend::text_color() const {
        return text_color_;
    }
    ...
    size_t legend::num_columns() const {
        return num_columns_;
    }
