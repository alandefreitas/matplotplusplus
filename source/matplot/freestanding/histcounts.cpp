...
std::pair<std::vector<double>, std::vector<double>> histcounts(const std::vector<double>& data,
    ...
    return std::make_pair(histogram::histogram_normalize(bin_counts, edges, data.size(), normalization_alg), edges);
}
...
/// \return pair with <values,edges>
std::pair<std::vector<double>, std::vector<double>> histcounts(const std::vector<double>& data, size_t nbins,
                                                               enum histogram::normalization normalization_alg) {
    double minx = *std::min_element(data.begin(), data.end());
    double maxx = *std::max_element(data.begin(), data.end());
...
std::vector<double> histcounts(const std::vector<double>& data, const std::vector<double>& edges,
                               enum histogram::normalization normalization_alg) {
    auto bin_counts = histogram::histogram_count(data, edges);
...
std::vector<std::vector<double>> histnormalize2(const std::vector<std::vector<size_t>>& bin_count,
...
std::vector<std::vector<double>> histcounts2(const std::vector<double>& x_data, const std::vector<double>& y_data,
