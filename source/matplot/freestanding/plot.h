 ...
 *     functions without templates to make the use of initializer lists possible.
 */
namespace matplot {
    ...
    inline line_handle plot(axes_handle ax, const std::vector<double> &x, const std::vector<double> &y, const std::string &line_spec = "") {
    ...
    template <class ...Args>
    auto plot(axes_handle ax, const std::vector<double> &x, const std::vector<double> &y, const std::string &line_spec, Args... args) {
        return ax->plot(x,y,line_spec,args...);
    }

    template <class ...Args>
    auto plot(axes_handle ax, const std::vector<double> &x, const std::vector<double> &y, const std::vector<double> &x2, Args... args) {
    ...
    inline contours_handle
    fcontour(axes::fcontour_function_type fn, const std::array<double, 4> &xy_range, std::vector<double> levels,
    ...
    inline contours_handle
    fcontour(axes_handle ax, axes::fcontour_function_type fn, const std::array<double, 4> &xy_range, std::vector<double> levels, const std::string &line_spec = "") {
    ...
    inline surface_handle fsurf(axes_handle ax,
                         axes::fcontour_function_type funx,
                         axes::fcontour_function_type funy,
                         axes::fcontour_function_type funz,
                         const std::array<double, 2> &u_range,
                         const std::array<double, 2> &v_range,
    ...
    inline labels_handle text(const std::vector<double> &x, const std::vector<double> &y, const std::vector<std::string> &texts) {
    ...
    inline labels_handle text(axes_handle ax, const std::vector<double> &x, const std::vector<double> &y, const std::vector<std::string> &texts) {
