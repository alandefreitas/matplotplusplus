...
template <class... Args>
auto plot(axes_handle ax, Args... args) {
    return ax->plot(args...);
}

inline line_handle plot(const std::vector<double> &x, const std::vector<double> &y, const std::string &line_spec = "") {
    return gca()->plot(x, y, line_spec);
}

inline line_handle plot(const std::vector<double> &y, const std::string &line_spec = "") {
...
inline line_handle plot(axes_handle ax, const std::vector<double> &x, const std::vector<double> &y,
                        const std::string &line_spec = "") {
    return ax->plot(x, y, line_spec);
}

inline line_handle plot(axes_handle ax, const std::vector<double> &y, const std::string &line_spec = "") {
    return ax->plot(y, line_spec);
}

template <class... Args>
auto plot(axes_handle ax, const std::vector<double> &x, const std::vector<double> &y, const std::string &line_spec,
          Args... args) {
    return ax->plot(x, y, line_spec, args...);
}

template <class... Args>
auto plot(axes_handle ax, const std::vector<double> &x, const std::vector<double> &y, const std::vector<double> &x2,
          Args... args) {
    return ax->plot(x, y, x2, args...);
}

template <class... Args>
auto plot(axes_handle ax, const std::vector<double> &y, const std::string &line_spec, Args... args) {
...
template <class... Args>
auto loglog(axes_handle ax, Args... args) {
...
template <class... Args>
auto semilogx(axes_handle ax, Args... args) {
...
template <class... Args>
auto semilogy(axes_handle ax, Args... args) {
...
template <class... Args>
auto rgbplot(axes_handle ax, Args... args) {
...
template <class... Args>
auto plot3(axes_handle ax, Args... args) {
...
template <class... Args>
auto stairs(axes_handle ax, Args... args) {
...
template <class... Args>
auto errorbar(axes_handle ax, Args... args) {
...
template <class... Args>
auto area(axes_handle ax, Args... args) {
    return ax->area(args...);
}
...
template <class... Args>
auto fplot(axes_handle ax, Args... args) {
...
template <class... Args>
auto fimplicit(axes_handle ax, Args... args) {
...
template <class... Args>
auto fplot3(axes_handle ax, Args... args) {
...
template <class... Args>
auto hist(axes_handle ax, Args... args) {
    return ax->hist(args...);
}

inline size_t morebins(histogram_handle h, double bin_increase = 0.1) { return h->morebins(bin_increase); }

inline size_t fewerbins(histogram_handle h, double bin_decrease = 0.1) { return h->fewerbins(bin_decrease); }
...
template <class... Args>
auto binscatter(axes_handle ax, Args... args) {
...
template <class... Args>
auto hist2(axes_handle ax, Args... args) {
...
template <class... Args>
auto bar(axes_handle ax, Args... args) {
    return ax->bar(args...);
}
...
template <class... Args>
auto barstacked(axes_handle ax, Args... args) {
...
template <class... Args>
auto heatmap(axes_handle ax, Args... args) {
...
template <class... Args>
auto pcolor(axes_handle ax, Args... args) {
...
template <class... Args>
auto parallelplot(axes_handle ax, Args... args) {
...
template <class... Args>
auto pie(axes_handle ax, Args... args) {
    return ax->pie(args...);
}
...
template <class... Args>
auto plotmatrix(figure_handle f, Args... args) {
...
template <class... Args>
auto scatter(axes_handle ax, Args... args) {
...
template <class... Args>
auto scatter3(axes_handle ax, Args... args) {
...
template <class... Args>
auto wordcloud(axes_handle ax, Args... args) {
...
template <class... Args>
auto pareto(axes_handle ax, Args... args) {
...
template <class... Args>
auto stem(axes_handle ax, Args... args) {
    return ax->stem(args...);
}
...
template <class... Args>
auto stem3(axes_handle ax, Args... args) {
...
template <class... Args>
auto geobubble(axes_handle ax, Args... args) {
...
template <class... Args>
auto geodensityplot(axes_handle ax, Args... args) {
...
template <class... Args>
auto geoplot(axes_handle ax, Args... args) {
...
template <class... Args>
void geolimits(axes_handle ax, Args... args) {
    ax->geolimits(args...);
}

inline void geolimits(const std::array<double, 2> &latitude, const std::array<double, 2> &longitude) {
    gca()->geolimits(latitude, longitude);
}

inline void geolimits(axes_handle ax, const std::array<double, 2> &latitude, const std::array<double, 2> &longitude) {
...
template <class... Args>
auto geoscatter(axes_handle ax, Args... args) {
...
template <class... Args>
auto compass(axes_handle ax, Args... args) {
...
template <class... Args>
auto ezpolar(axes_handle ax, Args... args) {
...
template <class... Args>
auto polarhistogram(axes_handle ax, Args... args) {
...
template <class... Args>
auto polarplot(axes_handle ax, Args... args) {
...
template <class... Args>
auto polarscatter(axes_handle ax, Args... args) {
    return ax->polarscatter(args...);
}

template <class... Args>
auto contour(axes_handle ax, Args... args) {
    return ax->contour(args...);
}

template <class T1, class T2, class T3>
auto contour(axes_handle ax, T1 v1, T2 v2, T3 v3, const std::vector<double> &il) {
...
template <class... Args>
auto contourf(axes_handle ax, Args... args) {
    return ax->contourf(args...);
}

template <class T1, class T2, class T3>
auto contourf(axes_handle ax, T1 v1, T2 v2, T3 v3, const std::vector<double> &il) {
...
template <class... Args>
auto fcontour(axes_handle ax, Args... args) {
...
inline contours_handle fcontour(axes::fcontour_function_type fn, const std::array<double, 4> &xy_range,
                                std::vector<double> levels, const std::string &line_spec = "") {
    return gca()->fcontour(fn, xy_range, levels, line_spec);
}

inline contours_handle fcontour(axes::fcontour_function_type fn, const std::string &line_spec) {
    return gca()->fcontour(fn, line_spec);
}

inline contours_handle fcontour(axes_handle ax, axes::fcontour_function_type fn, const std::array<double, 4> &xy_range,
                                std::vector<double> levels, const std::string &line_spec = "") {
    return ax->fcontour(fn, xy_range, levels, line_spec);
}

inline contours_handle fcontour(axes_handle ax, axes::fcontour_function_type fn, const std::string &line_spec) {
...
template <class... Args>
auto feather(axes_handle ax, Args... args) {
...
template <class... Args>
auto quiver(axes_handle ax, Args... args) {
...
template <class... Args>
auto quiver3(axes_handle ax, Args... args) {
...
template <class... Args>
auto fence(axes_handle ax, Args... args) {
...
template <class... Args>
auto fmesh(axes_handle ax, Args... args) {
...
template <class... Args>
auto fsurf(axes_handle ax, Args... args) {
    return ax->fsurf(args...);
}

inline surface_handle fsurf(axes::fcontour_function_type fn, const std::array<double, 2> &x_range,
                            const std::array<double, 2> &y_range, std::string line_spec = "",
                            double mesh_density = 40) {
    return gca()->fsurf(fn, x_range, y_range, line_spec, mesh_density);
}

inline surface_handle fsurf(axes::fcontour_function_type funx, axes::fcontour_function_type funy,
                            axes::fcontour_function_type funz, const std::array<double, 2> &u_range,
                            const std::array<double, 2> &v_range, std::string line_spec = "",
                            double mesh_density = 40) {
    return gca()->fsurf(funx, funy, funz, u_range, v_range, line_spec, mesh_density);
}

/// Function surf
/// Grid / Both ranges in the same array size 4
inline surface_handle fsurf(axes::fcontour_function_type fn, const std::array<double, 4> &xy_range,
...
/// Function surf
/// Grid / Both ranges in the same array size 4
inline surface_handle fsurf(axes::fcontour_function_type fn, std::initializer_list<double> xy_range,
                            std::string line_spec = "", double mesh_density = 40) {
    return gca()->fsurf(fn, xy_range, line_spec, mesh_density);
}
...
inline surface_handle fsurf(axes::fcontour_function_type funx, axes::fcontour_function_type funy,
                            axes::fcontour_function_type funz, const std::array<double, 4> &uv_range,
                            std::string line_spec = "", double mesh_density = 40) {
    return gca()->fsurf(funx, funy, funz, uv_range, line_spec, mesh_density);
}

/// Function surf
/// Grid / Both ranges in the same array size 2
inline surface_handle fsurf(axes::fcontour_function_type fn, const std::array<double, 2> &xy_range = {-5, +5},
                            std::string line_spec = "", double mesh_density = 40) {
    return gca()->fsurf(fn, xy_range, line_spec, mesh_density);
}
...
inline surface_handle fsurf(axes::fcontour_function_type funx, axes::fcontour_function_type funy,
                            axes::fcontour_function_type funz, const std::array<double, 2> &uv_range = {-5, +5},
                            std::string line_spec = "", double mesh_density = 40) {
    return gca()->fsurf(funx, funy, funz, uv_range, line_spec, mesh_density);
}

inline surface_handle fsurf(axes::fcontour_function_type funx, axes::fcontour_function_type funy,
                            axes::fcontour_function_type funz, std::initializer_list<double> &uv_range,
                            std::string line_spec = "", double mesh_density = 40) {
    return gca()->fsurf(funx, funy, funz, uv_range, line_spec, mesh_density);
}

/// Function surf - Core function
inline surface_handle fsurf(axes_handle ax, axes::fcontour_function_type fn, const std::array<double, 2> &x_range,
                            const std::array<double, 2> &y_range, std::string line_spec = "",
                            double mesh_density = 40) {
...
inline surface_handle fsurf(axes_handle ax, axes::fcontour_function_type funx, axes::fcontour_function_type funy,
                            axes::fcontour_function_type funz, const std::array<double, 2> &u_range,
                            const std::array<double, 2> &v_range, std::string line_spec = "",
                            double mesh_density = 40) {
    return ax->fsurf(funx, funy, funz, u_range, v_range, line_spec, mesh_density);
}

/// Function surf
/// Grid / Both ranges in the same array size 4
inline surface_handle fsurf(axes_handle ax, axes::fcontour_function_type fn, const std::array<double, 4> &xy_range,
                            std::string line_spec = "", double mesh_density = 40) {
...
inline surface_handle fsurf(axes_handle ax, axes::fcontour_function_type fn,
                            const std::array<double, 2> &xy_range = {-5, +5}, std::string line_spec = "",
                            double mesh_density = 40) {
    return ax->fsurf(fn, xy_range, line_spec, mesh_density);
}
...
template <class... Args>
auto mesh(axes_handle ax, Args... args) {
    return ax->mesh(args...);
}
...
template <class... Args>
auto meshc(axes_handle ax, Args... args) {
...
template <class... Args>
auto meshz(axes_handle ax, Args... args) {
...
template <class... Args>
auto ribbon(axes_handle ax, Args... args) {
...
template <class... Args>
auto surf(axes_handle ax, Args... args) {
    return ax->surf(args...);
}
...
template <class... Args>
auto surfc(axes_handle ax, Args... args) {
...
template <class... Args>
auto waterfall(axes_handle ax, Args... args) {
...
template <class... Args>
auto graph(axes_handle ax, Args... args) {
...
template <class... Args>
auto imshow(axes_handle ax, Args... args) {
...
template <class... Args>
auto image(axes_handle ax, Args... args) {
...
template <class... Args>
auto text(axes_handle ax, Args... args) {
    return ax->text(args...);
}

inline labels_handle text(const std::vector<double> &x, const std::vector<double> &y,
                          const std::vector<std::string> &texts) {
    return gca()->text(x, y, texts);
}

inline labels_handle text(const std::vector<double> &x, const std::vector<double> &y, const std::string &str) {
    return gca()->text(x, y, str);
}

inline labels_handle text(axes_handle ax, const std::vector<double> &x, const std::vector<double> &y,
                          const std::vector<std::string> &texts) {
...
template <class... Args>
auto arrow(axes_handle ax, Args... args) {
...
template <class... Args>
auto line(axes_handle ax, Args... args) {
    return ax->line(args...);
}
...
template <class... Args>
auto textarrow(axes_handle ax, Args... args) {
...
template <class... Args>
auto rectangle(axes_handle ax, Args... args) {
...
template <class... Args>
auto textbox(axes_handle ax, Args... args) {
...
template <class... Args>
auto fill(axes_handle ax, Args... args) {
    return ax->fill(args...);
}
...
template <class... Args>
auto polygon(axes_handle ax, Args... args) {
...
template <class... Args>
auto ellipse(axes_handle ax, Args... args) {
...
template <class... Args>
auto digraph(axes_handle ax, Args... args) {
...
template <class... Args>
auto imagesc(axes_handle ax, Args... args) {
...
template <class... Args>
auto boxplot(axes_handle ax, Args... args) {
...
template <class... Args>
auto boxchart(axes_handle ax, Args... args) {
