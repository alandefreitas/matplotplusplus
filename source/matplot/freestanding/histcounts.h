...
std::pair<std::vector<double>, std::vector<double>> histcounts(
    ...
    enum histogram::binning_algorithm binning_alg = histogram::binning_algorithm::automatic,
...
std::vector<std::vector<double>> histcounts2(
    const std::vector<double>& x_data, const std::vector<double>& y_data, const std::vector<double>& x_edges,
    const std::vector<double>& y_edges,
    enum histogram::normalization normalization_algorithm = histogram::normalization::count);
}  // namespace matplot
