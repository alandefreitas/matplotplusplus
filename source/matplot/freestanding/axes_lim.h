...
void xlim(axes_handle ax, Args... args) {
    ax->xlim(args...);
}
...
template <class T, class... Args>
void cblim(axes_handle ax, Args... args) {
    ax->cblim(args...);
}
...
template <class T, class... Args>
void caxis(axes_handle ax, Args... args) {
    ax->cblim(args...);
}
...
template <class T, class... Args>
void x2lim(axes_handle ax, Args... args) {
    ax->x2lim(args...);
}
...
template <class T, class... Args>
void ylim(axes_handle ax, Args... args) {
    ax->ylim(args...);
}
...
template <class T, class... Args>
void y2lim(axes_handle ax, Args... args) {
    ax->y2lim(args...);
}
...
template <class T, class... Args>
void zlim(axes_handle ax, Args... args) {
    ax->zlim(args...);
}
...
template <class T, class... Args>
void rlim(axes_handle ax, Args... args) {
    ax->rlim(args...);
}
...
template <class T, class... Args>
void tlim(axes_handle ax, Args... args) {
    ax->tlim(args...);
}
...
inline const std::array<double, 2> &xlim(axes_handle ax) { return ax->xlim(); }

inline void xlim(axes_handle ax, const std::array<double, 2> &lim) { ax->xlim(lim); }

inline const std::array<double, 2> &x2lim(axes_handle ax) { return ax->x2lim(); }

inline void x2lim(axes_handle ax, const std::array<double, 2> &lim) { ax->x2lim(lim); }

inline const std::array<double, 2> &ylim(axes_handle ax) { return ax->ylim(); }

inline void ylim(axes_handle ax, const std::array<double, 2> &lim) { ax->ylim(lim); }

inline const std::array<double, 2> &y2lim(axes_handle ax) { return ax->y2lim(); }

inline void y2lim(axes_handle ax, const std::array<double, 2> &lim) { ax->y2lim(lim); }

inline const std::array<double, 2> &zlim(axes_handle ax) { return ax->zlim(); }

inline void zlim(axes_handle ax, const std::array<double, 2> &lim) { ax->zlim(lim); }

inline const std::array<double, 2> &rlim(axes_handle ax) { return ax->rlim(); }

inline void rlim(axes_handle ax, const std::array<double, 2> &lim) { ax->rlim(lim); }

inline const std::array<double, 2> &tlim(axes_handle ax) { return ax->tlim(); }

inline void tlim(axes_handle ax, const std::array<double, 2> &lim) { ax->tlim(lim); }
}  // namespace matplot
