...
struct has_iterable_value_type {
    ...
    static false_type check(...);
    template <class T>
    static true_type check(int, typename T::value_type::value_type = *(C().begin()->begin()));
...
template <class C>
struct is_iterable_value : public std::integral_constant<bool, is_iterable_v<C> && !has_iterable_value_type_v<C>> {};
...
template <class C>
struct is_iterable_iterable : public std::integral_constant<bool, is_iterable_v<C> && has_iterable_value_type_v<C>> {};
...
template <class T>
using is_string =
    std::integral_constant<bool, std::is_same_v<std::decay_t<T>, std::string> && std::is_convertible_v<T, std::string>>;
...
template <class C>
struct is_iterable_pair : public std::integral_constant<bool, is_iterable_v<C> && !has_iterable_value_type_v<C> &&
